...
* Description: This file is created to summarize project-level data of porgrams 
			   targeted at the informal sector.

* Update 1: add labels, Feb 20 - "complete labels for a few variables" 
* Update 2: remove non-validated vars - Mar 03 - "removed 'finance source' and 'targeting method'"
********************************************************************************/
