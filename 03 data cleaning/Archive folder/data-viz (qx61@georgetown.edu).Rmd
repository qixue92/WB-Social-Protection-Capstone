...
figure1 %>% 
   ...
   labs(title = "Figure 1. Evolution in number of countries/territories and social protection measures",
         x = "Number of month since Mar 2020",
...
figure4 %>% 
  ...
  geom_col(aes(x = factor(duration_month, 
                          levels = c("less than a month", "1 month", 
                                     "2 months", "3 months",
                                     "4 months", "5 months", 
                                     "6 months", "7 months",
                                     "8 months", "9 months")), 
  ...
  geom_vline(xintercept = 3.84, color = "red",
             name = "Average") + # name is not showing up
...
# plot the data
ggplot() +
  geom_segment(data = figure5,
               aes(y = combined, yend = combined, x = 0, xend = .5), color="#b2b2b2", size = 0.1) +
  geom_dumbbell(data = figure5, 
                aes(y = combined, x = sa_app, xend = sa_ppp),
                size = 1.5, color = "#b2b2b2", 
                size_x = 3, size_xend = 3, 
                colour_x = "#82d58c", colour_xend = "lightblue3") +
  legend()
```
